...
public final class ReservoirLongsSketch {
  ...
  private ReservoirLongsSketch(final int k, final ResizeFactor rf) {
    ...
    final int ceilingLgK = Util.exactLog2OfInt(Util.ceilingPowerOf2(reservoirSize_), "ReservoirLongsSketch");
  ...
  public static ReservoirLongsSketch heapify(final Memory srcMem) {
    ...
    if (itemsSeen < k) {
      ...
      final int ceilingLgK = Util.exactLog2OfInt(Util.ceilingPowerOf2(k), "k");
      final int minLgSize = Util.exactLog2OfInt(Util.ceilingPowerOf2((int) itemsSeen), "heapify");
   ...
   */
  public void reset() {
    final int ceilingLgK = Util.exactLog2OfInt(Util.ceilingPowerOf2(reservoirSize_),
